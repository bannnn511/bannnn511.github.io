...
date: 2025-04-05
tags: [unix, socket, c]
summary: "A simple TCP server-client implementation using sockets in C. This article explains the socket system calls, the server-client flow, and how to scale the server to handle multiple clients using threads."
---
