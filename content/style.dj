...
My personal notes on programming style, research methodology, and technical writing practices.
...
- Use descriptive variable names, avoid abbreviations except for well-known conventions
...
- Use the right tool for the job - sometimes assembly is necessary, sometimes high-level is better

## Research and Writing

### Paper Analysis
- Always read the paper multiple times - first for understanding, then for critical analysis
...
*These are personal guidelines that evolve as I learn and grow as a programmer and researcher.*
...
handling requires complicated type-system machinery and is better avoided. Usually, standard library
